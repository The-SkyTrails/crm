...
class VisaCategoryForm(forms.ModelForm):
    class Meta:
        model = VisaCategory
        fields = ['visa_country_id', 'category','status']
...
class VisasubCategoryForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['country_id','category_id','subcategory_name','estimate_amt','cgst','sgst','status']
        widgets = {'country_id':forms.Select(attrs={'class':'form-control'}),'category_id':forms.Select(attrs={'class':'form-control'}),'subcategory_name':forms.TextInput(attrs={'class':'form-control'}),'estimate_amt':forms.NumberInput(attrs={'class':'form-control'}),'cgst':forms.NumberInput(attrs={'class':'form-control'}),'sgst':forms.NumberInput(attrs={'class':'form-control'})}
...
class DocumentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'document_name':forms.TextInput(attrs={'class':'form-control', 'Placeholder':'Document Name'}),'document_category':forms.Select(attrs={'class':'form-control'}),'document_size':forms.TextInput(attrs={'class':'form-control','placeholder':'Document Size'})}        
class courieraddressForm(forms.ModelForm):
    class Meta:
        model = CourierAddress
        fields = ['company_name','address','landmark','city','state','zipcode']
        widgets = {'company_name':forms.TextInput(attrs={'class':'form-control'}),'address':forms.TextInput(attrs={'class':'form-control'}),'landmark':forms.TextInput(attrs={'class':'form-control'}),'city':forms.TextInput(attrs={'class':'form-control'}),'state':forms.TextInput(attrs={'class':'form-control'}),'zipcode':forms.NumberInput(attrs={'class':'form-control'})}
...
class PackageForm(forms.ModelForm):
    class Meta:
        model = Package
        fields = ['visa_country','visa_category','visa_subcategory','title','description','number_of_visa','amount','advance_amount','file_charges','image','package_expiry_date','assign_to_group']
        widgets = {'visa_country':forms.Select(attrs={'class':'form-control'}),'visa_category':forms.Select(attrs={'class':'form-control'}),'visa_subcategory':forms.Select(attrs={'class':'form-control'}),'title':forms.TextInput(attrs={'class':'form-control','placeholder': 'Enter Title Name'}),'description':forms.TextInput(attrs={'class':'form-control','placeholder': 'Enter Description'}),
                   'number_of_visa':forms.TextInput(attrs={'class':'form-control','placeholder': 'Enter Number of Visa'}),'amount':forms.NumberInput(attrs={'class':'form-control','placeholder': 'Enter Amount'}),'advance_amount':forms.NumberInput(attrs={'class':'form-control','placeholder': 'Enter Advance Amount'}),
                   'file_charges':forms.NumberInput(attrs={'class':'form-control','placeholder': 'Enter File Charges'}),'package_expiry_date':forms.DateInput(attrs={'class':'form-control','placeholder': 'Enter Package Expiry Date','type':'date'}),'image':forms.FileInput(attrs={'class':'form-control'}),'word_doc':forms.FileInput(attrs={'class':'form-control'}),'assign_to_group':forms.Select(attrs={'class':'form-control'}),}
...
class CaseCategoryDocumentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ['last_updated_by', 'last_updated_on']

        widgets = {'country':forms.Select(attrs={'class':'form-control'}),'category':forms.Select(attrs={'class':'form-control'}),'subcategory':forms.Select(attrs={'class':'form-control'})}
...
class EnquiryForm(forms.ModelForm):
    class Meta:
        model = Enquiry
        fields = ['email','contact','Salutation','FirstName','LastName','Dob','Gender','Country','Visa_country','Visa_category'
                  ,'Visa_subcategory','Visa_type','Package','Source','Reference']
        widgets = {
            'email' : forms.EmailInput(attrs={'class':'form-control','placeholder':'Enter Email Id'}),
            ...
            'Source' : forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Source Name'}),
...
class EmployeeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['users','department','branch','contact_no','country','state','City','Address','zipcode','status','file','first_name']
...
#     class Meta:
#         model = AssignRoles
#         fields = ['menu_name','department','users']
#         widgets = {
#             'users': forms.Select(attrs={'class': 'form-control selectpicker', 'multiple': 'multiple', 'data-style': 'form-control btn-default btn-outline'}),
#             'menu_name': forms.Select(attrs={'class': 'form-control selectpicker', 'multiple': 'multiple', 'data-style': 'form-control btn-default btn-outline'}),
#             'department': forms.Select(attrs={'class': 'form-control', 'onchange': 'console.log("Department changed to: " + this.value);'}),
